  ...
  return (
    ...
    >
      <div className="absolute w-full h-full top-0 left-0">
        ...
        >
          <div
            className={` flex items-center justify-center flex-col   transition-all duration-200 delay-[0.7s] 
      ...
      lg:grid-cols-2">
        ...
        >
          ...
          <Image
            src={log}
            className={`  max-md:hidden max-lg:-translate-y-10 w-[200px] lg:w-full transition-transform 
